        ...
        <div className="max-w-full mb-12 lg:mb-16">
          ...
          <div className="flex gap-2 overflow-x-auto pb-2">
            {locationTags.map((location) => (
              <button key={location} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="relative whitespace-nowrap px-3 py-2 text-black text-opacity-60 font-urbanist text-base font-medium transition-colors">

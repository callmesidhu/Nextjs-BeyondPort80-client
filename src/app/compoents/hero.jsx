        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-16">
          ...
          <div className="flex flex-col gap-6 lg:max-w-[455px]">
            <div className="flex flex-col gap-2">
              ...
              <p className="font-urbanist text-lg lg:text-xl font-normal text-black tracking-wide">
          ...
          <div className="flex flex-col items-center gap-2 lg:max-w-[253px] lg:ml-auto">
            ...
            <span className="font-urbanist text-sm font-semibold text-black text-center">
              (Watch Reel)
            </span>
          </div>
        </div>
